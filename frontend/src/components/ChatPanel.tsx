    ...
    <div className="grid gap-4 lg:grid-cols-[280px_1fr]">
      ...
      <Card className="flex h-[28rem] flex-col">
        {!activeConversation ? (
          ...
          <>
            <h2 className="border-b border-brown-mid/10 pb-3 font-bold">{activeConversation.title}</h2>
            ...
            <form className="flex gap-2 border-t border-brown-mid/10 pt-3" onSubmit={send}>
              <Input label="" placeholder="Escreva uma mensagem..." value={draft} onChange={(event) => setDraft(event.target.value)} className="flex-1" />
